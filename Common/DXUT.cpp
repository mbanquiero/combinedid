...
void DXUTRender3DEnvironment()
{
	...
	if(!_redraw_window && _modo_interactivo)
		return;
	...
	// le dejo unos sec de repintados sucesivos para que termine de estabilizar los gui
	if(_modo_interactivo && fTime>5)
		_redraw_window = false;
    return;
}
